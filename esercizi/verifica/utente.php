    ...
    <?php
        ...
        if(isset($_SESSION['idUtente'])){
			...
			try {				
				...
				echo("<h3>Elenco candidati partner</h3><hr>" . $messaggio . "<hr>");
				$nAbb=0;
        ...
        echo("<button type='submit' onClick='chiudi_sessione()' fromaction='login.php' class='btn btn-dark'>Esci</button>");
		echo("<button type='submit' class='btn btn-success' formaction='esportaAbbinamentiUtente.php'>Esporta CSV abbinamenti</button>");
		echo("</form>");
